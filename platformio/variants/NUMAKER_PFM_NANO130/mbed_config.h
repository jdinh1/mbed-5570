...
#endif
#if !defined(MBED_CONF_NANO100_GPIO_IRQ_DEBOUNCE_ENABLE_LIST)
...
#endif
#if !defined(MBED_CONF_NANO100_GPIO_IRQ_DEBOUNCE_SAMPLE_RATE)
	#define MBED_CONF_NANO100_GPIO_IRQ_DEBOUNCE_SAMPLE_RATE (GPIO_DBCLKSEL_16)
#endif
#if !defined(MBED_CONF_NANO100_GPIO_IRQ_DEBOUNCE_ENABLE)
	#define MBED_CONF_NANO100_GPIO_IRQ_DEBOUNCE_ENABLE (0)
#endif
#if !defined(MBED_CONF_NANO100_GPIO_IRQ_DEBOUNCE_CLOCK_SOURCE)
